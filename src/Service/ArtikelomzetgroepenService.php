...
final class ArtikelomzetgroepenService extends AbstractService
{
     ...
     */
    public function v2ArtikelomzetgroepenGET(): \SpiderDead\SnelStartApi\Model\SnelStartB2BApiV2ModelsArtikelenArtikelOmzetGroepModelArray
    {
        $pathParams = [];
        $queryParams = [];
     ...
     * @throws \SpiderDead\SnelStartApi\Exception\ApiException
     */
    public function v2ArtikelomzetgroepenIdGET(string $id): \SpiderDead\SnelStartApi\Model\SnelStartB2BApiV2ModelsArtikelenArtikelOmzetGroepModel
    {
        $pathParams = [];
        $pathParams['id'] = $id;
        $queryParams = [];
