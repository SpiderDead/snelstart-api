...
final class AuthorizationService extends AbstractService
{
     ...
     */
    public function v2AuthorizationHasUserAccessToAdministrationGET(string $userIdentifier): \SpiderDead\SnelStartApi\Model\SnelStartB2BApiV2ModelsAuthorizationAdministrationAccessModel
    {
        $pathParams = [];
        $queryParams = [];
